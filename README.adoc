...
:page-seo-title: Deploying microservices to Microsoft Azure
:page-seo-description: A tutorial on how to deploy microservices to Microsoft Azure Kubernetes Service
:guide-author: Open Liberty
:page-essential: false
= Deploying microservices to Microsoft Azure Kubernetes Service
...
+
** Your Docker daemon must be started in order to perform the steps of this guide. 
