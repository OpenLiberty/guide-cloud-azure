...
[role=command]
```
az acr create -g guide-group -n guideregistry --sku Basic --admin-enabled
```
...
```
{
  ...
  "id": "/subscriptions/[subscription-id]/resourceGroups/guide-group/providers/Microsoft.ContainerRegistry/registries/guideregistry",
  "location": "[location]",
