...
Get the credentials of your cluster and connect it to Kubernetes using the `az aks get-credentials` command. The default Kubernetes configuration file that is updated with your cluster credentials is located at `~/.kube/config`. 
